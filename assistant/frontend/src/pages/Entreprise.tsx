              ...
              <>
                ...
                {isAdmin && (
                  <div className="bg-t-bg1 border border-t-stroke3 rounded-fluent px-4 py-3 text-caption1 text-t-fg3">
                    Le backend actuel expose la consultation des recruteurs et l'affectation aux services. L'ajout de membres par invitation n'est pas encore disponible côté API.
                  </div>
                )}
